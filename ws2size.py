...
def extract_product_details():
    try:
        ...
        # Locate all available sizes
        sizes_elements = driver.find_elements(By.CSS_SELECTOR, "ul.hSEbzK li a.CDDksN")
...
if all_products:
    ...
    df.to_excel("flipkart_products_size.xlsx", index=False)
    print(f"\nTotal products processed: {len(all_products)}")
    print("Data has been exported to 'flipkart_products_size.xlsx'.")
else:
